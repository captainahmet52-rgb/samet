...
const cardInfo = [
  ...
  { key: "kritik", title: "Kritik stok", icon: AlertTriangle, color: "text-amber-700", money: false, href: "/urunler?durum=kritik" },
] as const;
